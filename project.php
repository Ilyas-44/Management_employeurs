...
<div class="topnav" id="myTopnav">
  <a href="management.php" class="active">Home</a>
    <div class="right">
        ...
        <a href="javascript:void(0);" class="icon" onclick="myfunctionpr()">
            ...
            <center><div class="btn-group">
                    <button onclick="formfunctionpr()" >Ajouter Un Projet</button>
                    <button>Rechercher Un projet</button>
                    <button>Mes Projects favoris</button>
            </div></center>
   ...
   <center> <form  method="POST" id="form">
        ...
        <input type="text" name="DURE" ><br> <br>
        <label for="">DATE DE DEBUT :</label>
        <input type="date" name="DATE_DEBUT_PROJ" ><br><br> 
  ...
  <?php
    ...
    if(isset($_POST['AJOUTER'])){
        ...
        $sql= ("INSERT INTO PROJET (NOM,DURE,DATE_DEBUT_PROJ) 
        VALUES ('$NOM','$DURE','$DATE_DEBUT_PROJ')");
